...
* 
* Day15: Got it! sln->Properties->C/C++->cmd: -DHANDMADE_INTERNAL -DHANDMADE_SLOW
*/
...
internal bool32 DEBUGPlatformWriteEntireFile(char* Filename, uint32 MemorySize, void* Mmeory);
#endif
...
inline uint32 SafeTruncateUInit64(uint64 Value)
{
